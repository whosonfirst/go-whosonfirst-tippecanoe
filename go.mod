...
require (
	...
	github.com/whosonfirst/go-whosonfirst-iterate-organization v1.2.2
	github.com/whosonfirst/go-whosonfirst-iterate/v2 v2.5.0
	github.com/whosonfirst/go-whosonfirst-iterwriter/v3 v3.0.0
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-github v0.8.1 // indirect
	github.com/whosonfirst/go-whosonfirst-iterate-git/v2 v2.1.7 // indirect
